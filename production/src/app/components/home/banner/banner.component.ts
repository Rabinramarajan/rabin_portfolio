...
export class BannerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.experienceDate = this.experience.getExperienceYears(startDate);
    this.loadingSubscription = this.loading.animationsStarted$.subscribe((shouldStart) => {
  ...
  ngAfterViewInit(): void {
    ...
    if (this.loading.animationsStarted && !this.animationsStarted) {
      this.animationsStarted = true;
      this.initAnimations();
      this.showVideo();
    }
